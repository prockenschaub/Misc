...
for(i in 1:R){
  ...
  imp.al <- mice(data.missing.int, print = FALSE, m =5, maxit = 0, 
                method = myMethod, predictorMatrix=myPredMat,
                visitSequence = myVisSeq, blocks = myBlocks, seed = seeds[5])
  
  imp.al$visitSequence <- c("x", "y.miss", "z.miss", "xzint", "yzint", "xyint") # NOTE: this is the explicit visit sequence used by default in the original code
...
save(coef.fl, file = "pred/coef.fl.RData")
save(SE.fl, file = "pred/SE.fl.RData")
save(lower.fl, file = "pred/lower.fl.RData")
save(upper.fl, file = "pred/upper.fl.RData")
save(coef.cra, file = "pred/coef.cra.RData")
save(SE.cra, file = "pred/SE.cra.RData")
save(lower.cra, file = "pred/lower.cra.RData")
save(upper.cra, file = "pred/upper.cra.RData")
save(coef.st, file = "pred/coef.st.RData")
save(SE.st, file = "pred/SE.st.RData")
save(lower.st, file = "pred/lower.st.RData")
save(upper.st, file = "pred/upper.st.RData")
save(coef.y, file = "pred/coef.y.RData")
save(SE.y, file = "pred/SE.y.RData")
save(lower.y, file = "pred/lower.y.RData")
save(upper.y, file = "pred/upper.y.RData")
save(coef.al, file = "pred/coef.al.RData")
save(SE.al, file = "pred/SE.al.RData")
save(lower.al, file = "pred/lower.al.RData")
save(upper.al, file = "pred/upper.al.RData")
